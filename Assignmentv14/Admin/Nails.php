...
<?php
		...
		echo "<tr>".
				"<th>Nail Treatment Type</th><th>Cost</th><th>Update/Delete</th>".
			  "</tr>";
		$icount = 0 ;
		...
		{		
		  	...
		  	echo "<tr>".  
		  	 	  	 "<td> ".$row[1] . "</td>".
		  	 	     "<td> " .$row[2]. "</td>".
		  	 	        "<td> <a href=\"UpdateNails.php?id=$id\"> Update </a> - <a href=\"DeleteNails.php?id=$id\" onclick='return Confirm();' >Delete</a></td>".
