...
<?php
		...
		echo "<tr>".
				"<th>Phone Number</th><th>Email</th><th>Location</th><th>Update/Delete</th>".
			  "</tr>";
		$icount = 0 ;
		...
		{		
		  	...
		  	echo "<tr>".  
		  	 	     ...
		  	 	     "<td> "."<textarea id='box' readonly rows='5' cols='30'>". $row[2]."</textarea>"."</td>".
			  	         "<td> <a href=\"UpdateContactInfo.php?id=$id\"> Update </a> - <a href=\"DeleteContactInfo.php?id=$id\" onclick='return Confirm();' >Delete</a></td>".
		  	     "<tr>";
		  	 $icount++;
		  }
