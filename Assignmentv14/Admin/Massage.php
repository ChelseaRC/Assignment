...
<title>View/Edit Massages</title>
...
<?php
		...
		echo "<tr>".
				"<th>Massage Type</th><th>Cost</th><th>Update/Delete</th>".
			  "</tr>";
		$icount = 0 ;
		...
		{		
		  	...
		  	echo "<tr>".  
		  	 	  	 "<td> ".$row[1] . "</td>".
		  	 	     "<td> " .$row[2]. "</td>". 
		  	 	     "<td> <a href=\"UpdateMassage.php?id=$id\"> Update </a> - <a href=\"DeleteMassage.php?id=$id\" onclick='return Confirm();' >Delete</a></td>".
